...
class libhal_input_conan(ConanFile):
    name = "libhal-input"
    license = "Apache-2.0"
    homepage = "https://github.com/libhal/libhal-input"
    description = ("A collection of drivers for the input")
    ...
    def package_info(self):
        self.cpp_info.libs = ["libhal-input"]
        self.cpp_info.set_property("cmake_target_name", "libhal::input")
